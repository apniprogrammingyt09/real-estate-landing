  ...
  const services = [
    {
      ...
      color: "text-[#09090b]",
      bgColor: "bg-[#f4f4f5] dark:bg-[#f4f4f5]0/10",
    },
    {
      icon: Key,
    ...
    },
    {
      ...
      color: "text-[#09090b]",
      bgColor: "bg-[#ececee] dark:bg-[#ececee]",
    },
    {
      icon: Calculator,
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background font-sans selection:bg-[#ececee] selection:text-emerald-900">
        ...
        <div className="container-custom relative">
          <div className="max-w-5xl mx-auto text-center space-y-12">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <Link href="/listings">
                <Button variant="outline" className="h-20 px-12 rounded-full border-2 border-[#ececee] dark:border-gray-800 font-bold text-sm uppercase tracking-widest hover:bg-[#f4f4f5] dark:hover:bg-gray-900 transition-all">
                  View Listings
                </Button>
              </Link>
            </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {services.map((service, index) => (
              <div key={index} className="group p-12 bg-card text-card-foreground rounded-[36px] border border-[#ececee] dark:border-gray-800 border border-[#ececee] shadow-none hover:border border-[#ececee] shadow-none hover:-translate-y-2 transition-all duration-500 space-y-8">
                <div className={cn("w-20 h-20 rounded-[36px] flex items-center justify-center group-hover:scale-110 transition-transform", service.bgColor)}>
                  <service.icon className={cn("h-10 w-10", service.color)} />
                </div>
                <div className="space-y-4">
                  <h3 className="text-2xl font-sans tracking-tight">{service.title}</h3>
                ...
                <ul className="space-y-3 pt-6 border-t border-gray-50 dark:border-gray-800">
                  {service.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-3 text-xs font-bold text-gray-400 uppercase tracking-widest">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#f4f4f5]0"></div>
                      {feature}
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-[60px] bg-gray-900 text-white relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl mb-24 space-y-6">
            <h2 className="text-5xl md:text-7xl font-sans tracking-tighter leading-tight">The Blueprint of <br/> Our Methodology</h2>
            ...
            {steps.map((step, index) => (
              <div key={index} className="space-y-8 group">
                <div className="relative">
                  <div className="text-8xl font-sans text-white/5 tracking-tighter transition-colors group-hover:text-[#09090b]/20">{step.step}</div>
                  <div className="absolute bottom-4 left-0 w-12 h-1 bg-[#f4f4f5]0 rounded-full"></div>
                </div>
                <div className="space-y-4">
      ...
      <section className="py-[60px] bg-background">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center bg-[#f4f4f5] dark:bg-gray-900 rounded-[36px] p-12 md:p-24 border border-[#ececee] dark:border-gray-800 overflow-hidden relative">
            <div className="absolute top-0 right-0 w-96 h-96 bg-[#f4f4f5]0/5 rounded-full blur-3xl"></div>
            <div className="space-y-12 relative z-10">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-3 px-4 py-2 bg-[#f4f4f5]0 text-white rounded-full text-[10px] font-bold uppercase tracking-widest">
                  <Star className="w-3 h-3 fill-current" /> Premium Exclusive
                </div>
                <h2 className="text-5xl font-sans tracking-tighter leading-tight">Virtual Reality <br/> Immersive Tours</h2>
            ...
            <div className="relative aspect-square rounded-[36px] overflow-hidden border border-[#ececee] shadow-none group">
              <Image
      ...
      {/* Final CTA */}
      <section className="py-[60px] text-center bg-background">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto space-y-10">
            <h2 className="text-5xl md:text-8xl font-sans tracking-tighter leading-[0.9]">Elevate your property strategy.</h2>
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <Link href="/contact">
                <Button className="h-20 px-16 rounded-full bg-[#09090b] hover:bg-[#09090b] text-white font-bold text-sm uppercase tracking-widest border border-[#ececee] shadow-none shadow-emerald-600/20 transition-all hover:scale-105">
                  Start Consultation
                </Button>
              </Link>
              <Link href="/about">
