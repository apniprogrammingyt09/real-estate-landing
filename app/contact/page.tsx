...
import { MapPin, Phone, Clock, Send, Mail, Sparkles, ArrowRight, MessageSquare } from "lucide-react"
...
export default function ContactPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background font-sans selection:bg-emerald-100 selection:text-emerald-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
            ...
            <div className="lg:col-span-5 space-y-16">
              <div className="grid grid-cols-1 gap-12">
                <div className="space-y-6 group">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-serif tracking-tight">Main Headquarters</h3>
                ...
                <div className="space-y-6 group">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-serif tracking-tight">Direct Support</h3>
                    <p className="text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                      +91 98765 43210 <br/>
                      Mon - Sat, 9am - 7pm
                    </p>
                ...
                <div className="space-y-6 group">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-serif tracking-tight">Email Inquiries</h3>
                    <p className="text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                      hello@realestateelite.com <br/>
                      partners@realestateelite.com
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-10 bg-gray-900 rounded-[3rem] text-white space-y-6 relative overflow-hidden">
                ...
                <h3 className="text-2xl font-serif tracking-tight">Are you an Agent?</h3>
            ...
            <div className="lg:col-span-7">
              <div className="bg-white dark:bg-gray-900 p-12 lg:p-16 rounded-[4rem] border border-gray-100 dark:border-gray-800 shadow-2xl space-y-12">
                <div className="space-y-4">
                  <h2 className="text-3xl font-serif tracking-tight">Send a message</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        className="h-16 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border-gray-100 dark:border-gray-800 focus-visible:ring-emerald-500/20"
                        required
                      />
                    </div>
                    <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-3">
                      ...
                      <Select value={formData.subject} onValueChange={handleSubjectChange} required>
                        <SelectTrigger className="h-16 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border-gray-100 dark:border-gray-800 focus:ring-emerald-500/20 text-[10px] font-bold uppercase tracking-widest">
                  ...
                  <div className="space-y-3">
                    ...
                    <Textarea
                      ...
                      className="min-h-[180px] rounded-[2rem] bg-gray-50 dark:bg-gray-800/50 border-gray-100 dark:border-gray-800 focus-visible:ring-emerald-500/20 p-8"
                      required
                    />
                  </div>
                  ...
                  <Button
                    type="submit"
                    className="w-full h-20 rounded-[2rem] bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm uppercase tracking-widest shadow-xl shadow-emerald-600/20 transition-all hover:scale-[1.02]"
      ...
      <section className="py-24">
        <div className="container-custom">
          <div className="relative h-[600px] rounded-[4rem] overflow-hidden border border-gray-100 dark:border-gray-800 group shadow-2xl">
             <iframe 
              ...
              <div className="absolute inset-0 pointer-events-none flex items-center justify-center -translate-y-12">
                <div className="relative w-16 h-16 bg-emerald-600 rounded-full border-[6px] border-white dark:border-gray-900 shadow-2xl flex items-center justify-center animate-bounce">
