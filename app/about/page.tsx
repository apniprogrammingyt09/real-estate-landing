          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="space-y-12">
              <div className="space-y-6">
                <h2 className="text-5xl font-serif tracking-tight leading-tight text-gray-900 dark:text-white">A Decade of Architectural <br/> Mastery & Trust</h2>
      ...
      <section className="py-32 bg-gray-50 dark:bg-gray-900/50">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center space-y-6 mb-24">
            <h2 className="text-4xl md:text-6xl font-serif tracking-tight">Our Core Ethos</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card text-card-foreground p-12 rounded-[3rem] border border-gray-100 dark:border-gray-800 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group text-center">
              <div className="w-16 h-16 bg-emerald-50 dark:bg-emerald-500/10 rounded-2xl flex items-center justify-center mx-auto mb-8 text-emerald-600 group-hover:scale-110 transition-transform">
                <Heart className="w-8 h-8" />
              </div>
              <h3 className="text-2xl font-serif tracking-tight mb-4">Integrity First</h3>
            ...
            <div className="bg-card text-card-foreground p-12 rounded-[3rem] border border-gray-100 dark:border-gray-800 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group text-center">
              ...
              <h3 className="text-2xl font-serif tracking-tight mb-4">Mastery</h3>
            ...
            <div className="bg-card text-card-foreground p-12 rounded-[3rem] border border-gray-100 dark:border-gray-800 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group text-center">
              <div className="w-16 h-16 bg-amber-50 dark:bg-amber-500/10 rounded-2xl flex items-center justify-center mx-auto mb-8 text-amber-600 group-hover:scale-110 transition-transform">
                <TrendingUp className="w-8 h-8" />
              </div>
              <h3 className="text-2xl font-serif tracking-tight mb-4">Innovation</h3>
        ...
        <div className="container-custom relative z-10">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 md:gap-20 text-center">
            <div className="space-y-2">
              <div className="text-6xl md:text-8xl font-serif tracking-tighter text-emerald-400">13+</div>
              <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Years Active</div>
            </div>
            <div className="space-y-2">
              <div className="text-6xl md:text-8xl font-serif tracking-tighter text-emerald-400">5k+</div>
              <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Homes Sold</div>
            </div>
            <div className="space-y-2">
              <div className="text-6xl md:text-8xl font-serif tracking-tighter text-emerald-400">24/7</div>
              <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Support Availability</div>
            </div>
            <div className="space-y-2">
              <div className="text-6xl md:text-8xl font-serif tracking-tighter text-emerald-400">10k+</div>
      ...
      <section className="py-48 text-center">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto space-y-10">
            <h2 className="text-5xl md:text-8xl font-serif tracking-tighter leading-[0.9]">Start your legacy today.</h2>
